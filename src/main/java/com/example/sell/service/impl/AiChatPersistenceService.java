...
public class AiChatPersistenceService {
    ...
    public void saveSummaryIfChanged(String sessionId, String summaryContent) {
        ...
        try {
            ...
            insertMessage(sessionId, null, "system", "summary", summaryContent, null);
            stringRedisTemplate.opsForValue().set(
    ...
    public void saveUserMessage(String sessionId, String content) {
        saveUserMessage(sessionId, null, content);
    }

    public void saveUserMessage(String sessionId, String userId, String content) {
        insertMessage(sessionId, userId, "user", "message", content, null);
    }

    public void saveAssistantMessage(String sessionId, String content) {
        saveAssistantMessage(sessionId, null, content);
    }

    public void saveAssistantMessage(String sessionId, String userId, String content) {
        insertMessage(sessionId, userId, "assistant", "message", content, null);
    }

    public void saveSystemEvent(String sessionId, String eventType, String content, Map<String, Object> extra) {
        saveSystemEvent(sessionId, null, eventType, content, extra);
    }

    public void saveSystemEvent(String sessionId, String userId, String eventType, String content, Map<String, Object> extra) {
        insertMessage(sessionId, userId, "system", eventType, content, extra);
    }
    ...
    private void insertMessage(String sessionId, String userId, String role, String eventType, String content, Map<String, Object> extra) {
        if (!StringUtils.hasText(sessionId)) {
            return;
        }
        try {
            ...
            elasticAiSearchService.indexMemoryMessage(message);
        } catch (Exception e) {
